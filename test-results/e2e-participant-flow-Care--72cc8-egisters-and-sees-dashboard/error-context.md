...
- Name: e2e/participant-flow.spec.js >> Care Exchange E2E >> 1 - Participant registers and sees dashboard
- Location: e2e/participant-flow.spec.js:18:7
...
Call log:
  - waiting for locator('input[name="full_name"], input[placeholder*="name" i]')
