...
- Name: e2e/participant-flow.spec.js >> Care Exchange E2E >> 4 - Participant grants consent via API then visits Care Team page
- Location: e2e/participant-flow.spec.js:50:7
