...
- Name: e2e/participant-flow.spec.js >> Care Exchange E2E >> 3 - Provider registers
- Location: e2e/participant-flow.spec.js:40:7
...
Call log:
  - waiting for locator('input[placeholder*="name" i]')
    - waiting for" https://care-exchange.onrender.com/register" navigation to finish...
    - navigated to "https://care-exchange.onrender.com/register"
