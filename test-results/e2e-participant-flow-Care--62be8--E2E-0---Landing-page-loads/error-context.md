...
- Name: e2e/participant-flow.spec.js >> Care Exchange E2E >> 0 - Landing page loads
- Location: e2e/participant-flow.spec.js:13:7
...
Locator: locator('text=Care Exchange')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=Care Exchange')
